...
The following function makes an accessibility matrix based on the bed files located in the folder 'path'. The entries of this matrix correspond to the number of integrations in a given region and cell.
```
